...
{
    FFMContext *ffm = (FFMContext *)s->priv_data;
...
static int ffm_close(AVFormatContext *s)
{
    ...
    for (i = 0; i < s->nb_streams; i++)
        av_freep((void*)&s->streams[i]->codec->rc_eq);
...
static int ffm_read_header(AVFormatContext *s, AVFormatParameters *ap)
{
    ...
    for(i=0;i<nb_streams;i++) {
        ...
        codec = st->codec;
        /* generic info */
        codec->codec_id = (CodecID)avio_rb32(pb);
        codec->codec_type = (AVMediaType)avio_r8(pb); /* codec_type */
        ...
        case AVMEDIA_TYPE_VIDEO:
            ...
            codec->pix_fmt = (PixelFormat)avio_rb32(pb);
