...
#if !defined(SHP) && ( defined(_WIN32) || defined(_WIN64) || defined(WIN32) || defined(WIN64) )
...
#define sscanf		kdSscanf
#define sprintf		kdSprintf
#define printf		kdPrintf
