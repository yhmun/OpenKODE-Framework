                            ...
                            AVFormatParameters *ap)
{
    ...
    chunk_size =   (int *)av_malloc(frame_count * sizeof(uint32_t));
    audio_size =   (int *)av_malloc(frame_count * sizeof(uint32_t));
    chunk_offset = (unsigned int*)av_malloc(frame_count * sizeof(uint32_t));
...
static int rl2_read_packet(AVFormatContext *s,
                            AVPacket *pkt)
{
    Rl2DemuxContext *rl2 = (Rl2DemuxContext *)s->priv_data;
    AVIOContext *pb = s->pb;
