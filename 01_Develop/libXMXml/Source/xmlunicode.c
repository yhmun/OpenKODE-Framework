...
static xmlChRangeGroup xmlLmG = {20,0,xmlLmS, KD_NULL};
...
static xmlChRangeGroup xmlLtG = {10,0,xmlLtS, KD_NULL};
...
static const xmlChSRange xmlPdS[] = {{0x2d, 0x2d}, {0x58a, 0x58a}, 
    ...
    {0xff0d, 0xff0d} };
static xmlChRangeGroup xmlPdG = {11,0,xmlPdS, KD_NULL};
...
static const xmlChSRange xmlPeS[] = {{0x29, 0x29}, {0x5d, 0x5d}, 
    ...
    {0xff63, 0xff63} };
static xmlChRangeGroup xmlPeG = {63,0,xmlPeS,KD_NULL};
...
static xmlChRangeGroup xmlPsG = {65,0,xmlPsS,KD_NULL};
...
static xmlChRangeGroup xmlScG = {13,0,xmlScS,KD_NULL};
...
static xmlChRangeGroup xmlSkG = {22,0,xmlSkS,KD_NULL};
...
static xmlChRangeGroup xmlZG = {9,0,xmlZS,KD_NULL};
 ...
 *
 * Returns pointer to range function if found, otherwise KD_NULL
 */
static xmlIntFunc
*xmlUnicodeLookup(xmlUnicodeNameTable *tptr, const char *tname) {
    ...
    if ((tptr == KD_NULL) || (tname == KD_NULL)) return(KD_NULL);
    ...
    while (low <= high) {
	mid = (low + high) / 2;
	if ((cmp= kdStrcmp(tname, sptr[mid].rangename)) == 0)
