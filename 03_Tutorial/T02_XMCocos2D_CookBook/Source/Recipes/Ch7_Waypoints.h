...
#ifndef __Ch7_Waypoints_h__
#define __Ch7_Waypoints_h__

#include "Libraries/GameArea2D.h"
#include "Libraries/GameActor.h"
#include "Libraries/DrawLayer.h"

class Ch7_Waypoints : public GameArea2D
{
	public :

		SCENE_FUNC ( Ch7_Waypoints );
	...
	protected :		
		...
		KDvoid				reachedWaypoint ( KDvoid );

		KDvoid				movingToWaypoint ( KDvoid );
