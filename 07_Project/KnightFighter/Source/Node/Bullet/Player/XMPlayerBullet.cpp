/* --------------------------------------------------------------------------
 *
 *      File            XMPlayerBullet.cpp
 *      Description     XMPlayerBullet
 *      Author          J.S Park
...
KDbool XMPlayerBullet::initWithFile ( const std::string& sFilename )
{
	...
	if ( pFixture != KD_NULL )
	{
		...
		tFilter.categoryBits = CATEGORY_PBULLET;
		tFilter.groupIndex = GROUPINDEX_PLAYER;
