...
public:
    ...
    EdgeShapes()
    {
        // Ground body
        {
            ...
            float32 x1 = -20.0f;
            float32 y1 = 2.0f * kdCosf(x1 / 10.0f * b2_pi);
            for (int32 i = 0; i < 80; ++i)
            {
                float32 x2 = x1 + 0.5f;
                float32 y2 = 2.0f * kdCosf(x2 / 10.0f * b2_pi);
    ...
    void Create(int32 index)
    {
        ...
        float32 x = kdRandomFloat(-10.0f, 10.0f);
        float32 y = kdRandomFloat(10.0f, 20.0f);
        bd.position.Set(x, y);
        bd.angle = kdRandomFloat(-b2_pi, b2_pi);
    ...
    void Step(Settings* settings)
    {
        ...
        b2Vec2 d(L * kdCosf(m_angle), -L * b2Abs(kdSinf(m_angle)));
