...
#include "XMFFmpeg/libavutil/common.h"      /* offsetof */
...
static const float lsf_3_mean[LP_FILTER_ORDER] = {
     377.441f,  554.688f,  922.363f, 1339.84f, 1702.15f,
    2046.390f, 2452.880f, 2741.460f, 3116.70f, 3348.14f
};

static const float lsf_5_mean[LP_FILTER_ORDER] = {
     337.891f,  507.080f,  834.961f, 1247.07f, 1646.00f,
    1982.910f, 2407.960f, 2708.010f, 3104.00f, 3344.97f
};

/** Prediction factor table for modes other than 12.2kbit/s */
static const float pred_fac[LP_FILTER_ORDER] = {
    0.291626f, 0.328644f, 0.383636f, 0.405640f, 0.438873f,
    0.355560f, 0.323120f, 0.298065f, 0.262238f, 0.197876f,
};
...
static const float energy_pred_fac[4] = { 0.19f, 0.34f, 0.58f, 0.68f };
...
static const float ir_filter_strong_MODE_7k95[AMR_SUBFRAME_SIZE] = {
 0.817169f,  0.024445f,  0.076447f, -0.020844f, -0.042175f,  0.017761f,  0.018433f,
-0.038879f,  0.107147f, -0.179871f,  0.138367f, -0.015228f, -0.059204f,  0.091888f,
-0.154358f,  0.171326f, -0.060730f, -0.032379f, -0.044525f,  0.135559f, -0.021362f,
-0.162811f,  0.140656f,  0.013794f, -0.017975f, -0.102295f,  0.090118f,  0.038666f,
-0.036987f, -0.079041f,  0.052826f,  0.112000f, -0.136566f, -0.029755f,  0.134003f,
-0.077423f,  0.028961f, -0.041595f, -0.029877f,  0.174988f,
};

static const float ir_filter_strong[AMR_SUBFRAME_SIZE] = {
 0.448303f,  0.351501f,  0.038696f, -0.084259f, -0.173065f,  0.229309f, -0.001068f,
-0.085663f, -0.092773f,  0.147186f,  0.090088f, -0.257080f,  0.115509f,  0.044403f,
 0.066498f, -0.263580f,  0.245697f, -0.064178f, -0.044373f,  0.023712f,  0.033813f,
-0.072784f,  0.068787f, -0.011078f, -0.020569f, -0.064178f,  0.184509f, -0.173370f,
 0.032715f,  0.095306f, -0.154358f,  0.162109f, -0.071075f, -0.113770f,  0.211304f,
-0.118683f,  0.020599f, -0.054169f,  0.000885f,  0.309601f,
};

static const float ir_filter_medium[AMR_SUBFRAME_SIZE] = {
 0.923889f,  0.116913f, -0.123169f,  0.090698f, -0.031982f, -0.030579f,  0.075592f,
-0.092865f,  0.085907f, -0.068085f,  0.053497f, -0.049164f,  0.052307f, -0.054169f,
 0.047089f, -0.030762f,  0.013092f, -0.005157f,  0.014404f, -0.038574f,  0.066406f,
-0.082581f,  0.076996f, -0.049469f,  0.010498f,  0.025208f, -0.046661f,  0.052612f,
-0.050568f,  0.051910f, -0.062958f,  0.080688f, -0.093384f,  0.088409f, -0.060364f,
 0.016998f,  0.023804f, -0.041779f,  0.025696f,  0.019989f,
};
...
static const float highpass_zeros[2] = { -2.0f, 1.0f };
static const float highpass_poles[2] = { -1.933105469f, 0.935913085f };
static const float highpass_gain     = 0.939819335f;
