...
public:
	...
	*/
	...
	void pushMorph(Morph* morph,int morphTargetIndex,float weight);
	void popMorph(Morph* morph,int morphTargetIndex);
	void changeMorph(Morph* morph,int morphTargetIndex,float weight);
	void clearMorph(Morph* morph);
