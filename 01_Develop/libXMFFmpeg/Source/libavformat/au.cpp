...
static int put_au_header(AVIOContext *pb, AVCodecContext *enc)
{
    if(!enc->codec_tag)
        return -1;
    ffio_wfourcc(pb, (const uint8_t *)".snd");    /* magic number */
...
static const AVCodecTag* const _ff_au_demuxer[] = {codec_au_tags, 0};
AVInputFormat ff_au_demuxer = {
	...
	/*.read_play	  = */	0,
	/*.read_pause	  = */	0,
    /*.codec_tag	  = */	_ff_au_demuxer,
};
#endif

#if CONFIG_AU_MUXER
static const AVCodecTag* const _ff_au_muxer[] = {codec_au_tags, 0};
