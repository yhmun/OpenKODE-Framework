...
void TouchableSpriteTest::onEnter()
{
    ...
    m_pEventDispatcher->addEventListenerWithSceneGraphPriority(listener1, sprite1);
    m_pEventDispatcher->addEventListenerWithSceneGraphPriority(listener1->clone(), sprite2);
    m_pEventDispatcher->addEventListenerWithSceneGraphPriority(listener1->clone(), sprite3);
    ...
    auto removeAllTouchItem = MenuItemFont::create("Remove All Touch Listeners", [this](Object* sender){
        ...
        m_pEventDispatcher->removeEventListeners(EventListener::Type::TOUCH_ONE_BY_ONE);
...
public:
    ...
    void onEnter() override
    {
        ...
        {
            m_pEventDispatcher->addEventListenerWithFixedPriority(listener, _fixedPriority);
        }
        _listener = listener;
    }
    ...
    {
        m_pEventDispatcher->removeEventListener(_listener);
...
void RemoveListenerWhenDispatching::onEnter()
{
    ...
    auto toggleItem = MenuItemToggle::createWithCallback([=](Object* sender){
        if (*enable)
        {
            m_pEventDispatcher->removeEventListener(listener1);
...
void CustomEventTest::onEnter()
{
    ...
    m_pEventDispatcher->addEventListenerWithFixedPriority(_listener, 1);
    ...
    m_pEventDispatcher->addEventListenerWithFixedPriority(_listener2, 1);
...
{
    m_pEventDispatcher->removeEventListener(_listener);
    m_pEventDispatcher->removeEventListener(_listener2);
...
void LabelKeyboardEventTest::onEnter()
{
    ...
    m_pEventDispatcher->addEventListenerWithSceneGraphPriority(listener, statusLabel);
}
...
_pos = _max;        \
    ...
    m_pEventDispatcher->addEventListenerWithSceneGraphPriority(listener, sprite);
}
...
void RemoveAndRetainNodeTest::onEnter()
{
    ...
    m_pEventDispatcher->addEventListenerWithSceneGraphPriority(listener1, _sprite);
...
void RemoveListenerAfterAddingTest::onEnter()
{
    ...
    auto item1 = MenuItemFont::create("Click Me 1", [this](Object* sender){
        ...
        m_pEventDispatcher->addEventListenerWithFixedPriority(listener, -1);
        m_pEventDispatcher->removeEventListener(listener);
    });
