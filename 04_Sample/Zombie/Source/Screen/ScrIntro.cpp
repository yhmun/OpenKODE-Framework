...
KDbool CScrIntro::init ( KDvoid )
{
	...
	CCSprite*  pBG = g_pResMgr->getSprite ( this, eIMG_BG_Intro );
...
KDvoid CScrIntro::onEnterTransitionDidFinish ( KDvoid )
{
	CCLayer::onEnterTransitionDidFinish ( );

	this->scheduleOnce ( schedule_selector ( CScrIntro::onNextScreen ), 1.0f );
}

KDvoid CScrIntro::onNextScreen ( KDfloat fTime )
{
