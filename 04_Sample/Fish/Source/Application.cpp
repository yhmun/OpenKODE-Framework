...
#define XM_EMULATOR_CX		WIN_HEIGHT
#define XM_EMULATOR_CY		WIN_WIDTH
...
KDbool AppDelegate::applicationDidFinishLaunching ( KDvoid )
{
	...
	CCEGLView::sharedOpenGLView ( )->setDesignResolutionSize ( ccs ( WIN_WIDTH, WIN_HEIGHT ), kResolutionExactFit );
...
//	CCDirector::sharedDirector ( )->setDisplayStats ( KD_TRUE );
	...
	aPaths.push_back ( "ParticleEffect" );
