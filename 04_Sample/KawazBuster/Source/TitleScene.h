...
class TitleScene : public KWScene 
{
	public :

		SCENE_FUNC ( TitleScene );
	...
	protected :
		...
		KDvoid				pressStartButton  ( CCObject* pSender );

		KDvoid				pressCreditButton ( CCObject* pSender );

		KDvoid				pressHowtoButton  ( CCObject* pSender );
