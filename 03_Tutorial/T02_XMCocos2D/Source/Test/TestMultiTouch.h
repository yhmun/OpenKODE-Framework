...
#ifndef __TestMultiTouch_h__
#define __TestMultiTouch_h__

#include "../TestBasic.h"

class TestMultiTouch : public TestBasic
{
	public :

		CREATE_FUNC ( TestMultiTouch );
	...
	protected :
		...
		CCDictionary			m_tDictionary;
};

#endif	// __TestMultiTouch_h__
