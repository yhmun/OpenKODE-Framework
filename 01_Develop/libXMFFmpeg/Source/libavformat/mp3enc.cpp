                            ...
                            uint8_t *buf, int buf_size)
{
    ...
    if ((tag = av_dict_get(s->metadata, key, NULL, 0)))
        av_strlcpy((char *)buf, tag->value, buf_size);
    return !!tag;
}
...
static int mp2_write_trailer(struct AVFormatContext *s)
{
    ...
    MP3Context *mp3 = (MP3Context *)s->priv_data;
...
static const AVOption options[] = {
    { "id3v2_version", "Select ID3v2 version to write. Currently 3 and 4 are supported.",
      offsetof(MP3Context, id3v2_version), AV_OPT_TYPE_INT, 4, NULL, 3, 4, AV_OPT_FLAG_ENCODING_PARAM},
    { "write_id3v1", "Enable ID3v1 writing. ID3v1 tags are written in UTF-8 which may not be supported by most software.",
      offsetof(MP3Context, write_id3v1), AV_OPT_TYPE_INT, 0, NULL, 0, 1, AV_OPT_FLAG_ENCODING_PARAM},
    { NULL },
};
