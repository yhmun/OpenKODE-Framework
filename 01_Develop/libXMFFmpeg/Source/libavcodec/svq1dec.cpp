...
//              (csum == 0) ? "correct" : "incorrect", csum);
    ...
    if (frame_size_code == 7) {
      ...
      s->width = ff_svq1_frame_KDsizeable[frame_size_code].width;
      s->height = ff_svq1_frame_KDsizeable[frame_size_code].height;
    }
  }
                             ...
                             AVPacket *avpkt)
{
  ...
  pmv = (svq1_pmv *)av_malloc((FFALIGN(s->width, 16)/8 + 3) * sizeof(*pmv));
  if (!pmv)
      return -1;
...
static const enum PixelFormat _ff_svq1_decoder[] = {PIX_FMT_YUV410P, PIX_FMT_NONE};
