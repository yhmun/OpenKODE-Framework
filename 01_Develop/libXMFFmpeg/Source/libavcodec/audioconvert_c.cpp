...
#include "XMFFmpeg/libavutil/libm.h"
...
{
    return av_get_sample_fmt_name((AVSampleFormat)sample_fmt);
}
...
{
    av_get_sample_fmt_string(buf, buf_size, (AVSampleFormat)sample_fmt);
}
#endif
