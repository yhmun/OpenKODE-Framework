                  ...
                  AVLFG *rand_state)
{
    ...
    if (numpoints > 24*numCB) {
        ...
        int *temp_points = (int *)av_malloc(dim*(numpoints/8)*sizeof(int));
                ...
                AVLFG *rand_state)
{
    ...
    int *dist_cb = (int *)av_malloc(numpoints*sizeof(int));
    int *size_part = (int *)av_malloc(numCB*sizeof(int));
    cell *list_buffer = (cell *)av_malloc(numpoints*sizeof(cell));
    cell *free_cells;
    ...
    elbg->cells = (cell **)av_malloc(numCB*sizeof(cell *));
    elbg->utility = (int *)av_malloc(numCB*sizeof(int));
    elbg->nearest_cb = closest_cb;
    elbg->points = points;
    elbg->utility_inc = (int *)av_malloc(numCB*sizeof(int));
    elbg->scratchbuf = (int *)av_malloc(5*dim*sizeof(int));
