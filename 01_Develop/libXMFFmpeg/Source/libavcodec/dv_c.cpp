...
{
    DVVideoContext *s = (DVVideoContext *)avctx->priv_data;
    DVwork_chunk *work_chunk = (DVwork_chunk *)arg;
	...
	DECLARE_ALIGNED(16, DCTELEM, sblock) [5*DV_MAX_BPM][64];
...
static int dvvideo_encode_frame(AVCodecContext *c, uint8_t *buf, int buf_size,
                                void *data)
{
    DVVideoContext *s = (DVVideoContext *)c->priv_data;
...
#if CONFIG_DVVIDEO_ENCODER
static const enum PixelFormat _ff_dvvideo_encoder[] = {PIX_FMT_YUV411P, PIX_FMT_YUV422P, PIX_FMT_YUV420P, PIX_FMT_NONE};
