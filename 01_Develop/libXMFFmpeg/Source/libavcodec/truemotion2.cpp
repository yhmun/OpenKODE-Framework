...
static int tm2_build_huff_table(TM2Context *ctx, TM2Codes *code)
{
    ...
    huff.nums = (int *)av_mallocz(huff.max_num * sizeof(int));
    huff.bits = (uint32_t *)av_mallocz(huff.max_num * sizeof(uint32_t));
    huff.lens = (int *)av_mallocz(huff.max_num * sizeof(int));
    ...
    if(res != -1) {
        ...
        if(res != -1) {
            ...
            code->recode = (int *)av_malloc(code->length * sizeof(int));
...
static int tm2_read_stream(TM2Context *ctx, const uint8_t *buf, int stream_id, int buf_size)
{
    ...
    ctx->tokens[stream_id] = (int *)av_realloc(ctx->tokens[stream_id], toks * sizeof(int));
                        ...
                        AVPacket *avpkt)
{
    ...
    TM2Context * const l = (TM2Context *const)avctx->priv_data;
    AVFrame * const p= (AVFrame*)&l->pic;
    int i, skip, t;

    av_fast_padded_malloc(&l->buffer, (unsigned int *)&l->buffer_size, buf_size);
    if(!l->buffer){
...
static av_cold int decode_init(AVCodecContext *avctx){
    ...
    l->last = (int *)av_malloc(4 * sizeof(int) * (avctx->width >> 2));
    l->clast = (int *)av_malloc(4 * sizeof(int) * (avctx->width >> 2));
    ...
    l->Y1 = (int *)av_malloc(sizeof(int) * avctx->width * avctx->height);
    l->U1 = (int *)av_malloc(sizeof(int) * ((avctx->width + 1) >> 1) * ((avctx->height + 1) >> 1));
    l->V1 = (int *)av_malloc(sizeof(int) * ((avctx->width + 1) >> 1) * ((avctx->height + 1) >> 1));
    l->Y2 = (int *)av_malloc(sizeof(int) * avctx->width * avctx->height);
    l->U2 = (int *)av_malloc(sizeof(int) * ((avctx->width + 1) >> 1) * ((avctx->height + 1) >> 1));
    l->V2 = (int *)av_malloc(sizeof(int) * ((avctx->width + 1) >> 1) * ((avctx->height + 1) >> 1));
    l->cur = 0;
