...
static av_cold int wmv2_encode_init(AVCodecContext *avctx){
    Wmv2Context * const w= (Wmv2Context *const)avctx->priv_data;
    ...
    avctx->extradata= (uint8_t *)av_mallocz(avctx->extradata_size + 10);
    encode_ext_header(w);
...
static const enum PixelFormat _ff_wmv2_encoder[] = {PIX_FMT_YUV420P, PIX_FMT_NONE};
