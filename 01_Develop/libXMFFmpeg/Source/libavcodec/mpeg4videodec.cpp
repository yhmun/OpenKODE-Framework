...
static const AVOption mpeg4_options[] = {
    {"quarter_sample", "1/4 subpel MC", offsetof(MpegEncContext, quarter_sample), FF_OPT_TYPE_INT, 0, NULL, 0, 1, 0},
    {"divx_packed", "divx style packed b frames", offsetof(MpegEncContext, divx_packed), FF_OPT_TYPE_INT, 0, NULL, 0, 1, 0},
    {NULL}
};
...
static const enum PixelFormat[] _ff_mpeg4_vdpau_decoder = {PIX_FMT_VDPAU_MPEG4, PIX_FMT_NONE};
AVCodec ff_mpeg4_vdpau_decoder = {
	...
	/*.flush				= */	0,
	/*.supported_framerates	= */	0,
	/*.pix_fmts				= */	_ff_mpeg4_vdpau_decoder,
