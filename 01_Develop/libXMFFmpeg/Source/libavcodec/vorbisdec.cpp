...
typedef union  vorbis_floor_u 
{
    struct vorbis_floor0_s t0;
    struct vorbis_floor1_s t1;
} vorbis_floor_data;
...
static int vorbis_parse_setup_hdr_codebooks(vorbis_context *vc)
{
    ...
    vc->codebooks = (vorbis_codebook *)av_mallocz(vc->codebook_count * sizeof(*vc->codebooks));
    tmp_vlc_bits  = (uint8_t *)av_mallocz(V_MAX_VLCS * sizeof(*tmp_vlc_bits));
    tmp_vlc_codes = (uint32_t *)av_mallocz(V_MAX_VLCS * sizeof(*tmp_vlc_codes));
    codebook_multiplicands = (uint16_t *)av_malloc(V_MAX_VLCS * sizeof(*codebook_multiplicands));
...
// Weed out unused vlcs and build codevector vector
            codebook_setup->codevectors = used_entries ? (float *)av_mallocz(used_entries *
...
static int vorbis_parse_setup_hdr_floors(vorbis_context *vc)
{
    ...
    vc->floors = (vorbis_floor *)av_mallocz(vc->floor_count * sizeof(*vc->floors));
    ...
    for (i = 0; i < vc->floor_count; ++i) {
        ...
        if (floor_setup->floor_type == 1) {
            ...
            floor_setup->data.t1.list = (vorbis_floor1_entry *)av_mallocz(floor_setup->data.t1.x_list_dim *
...
// Precalculate order of x coordinates - needed for decode
            ...
            floor_setup->data.t0.book_list =
                (uint8_t *)av_malloc(floor_setup->data.t0.num_books);
            ...
            floor_setup->data.t0.lsp =
                (float *)av_malloc((floor_setup->data.t0.order + 1 + max_codebook_dim)
...
static int vorbis_parse_setup_hdr_residues(vorbis_context *vc)
{
    ...
    vc->residues      = (vorbis_residue *)av_mallocz(vc->residue_count * sizeof(*vc->residues));
    ...
    for (i = 0; i < vc->residue_count; ++i) {
        ...
        res_setup->classifs = (uint8_t *)av_malloc(res_setup->ptns_to_read *
                                        vc->audio_channels *
...
static int vorbis_parse_setup_hdr_mappings(vorbis_context *vc)
{
    ...
    vc->mappings      = (vorbis_mapping *)av_mallocz(vc->mapping_count * sizeof(*vc->mappings));
    ...
    for (i = 0; i < vc->mapping_count; ++i) {
        ...
        if (get_bits1(gb)) {
            ...
            mapping_setup->magnitude      = (uint8_t *)av_mallocz(mapping_setup->coupling_steps *
                                                       sizeof(*mapping_setup->magnitude));
            mapping_setup->angle          = (uint8_t *)av_mallocz(mapping_setup->coupling_steps *
        ...
        if (mapping_setup->submaps>1) {
            mapping_setup->mux = (uint8_t *)av_mallocz(vc->audio_channels *
...
static void create_map(vorbis_context *vc, unsigned floor_number)
{
    ...
    for (blockflag = 0; blockflag < 2; ++blockflag) {
        ...
        floors[floor_number].data.t0.map[blockflag] =
            (int32_t *)av_malloc((n + 1) * sizeof(int32_t)); // n + sentinel

        map =  floors[floor_number].data.t0.map[blockflag];
        vf  = (vorbis_floor0 *)&floors[floor_number].data.t0;
...
static int vorbis_parse_setup_hdr_modes(vorbis_context *vc)
{
    ...
    vc->modes      = (vorbis_mode *)av_mallocz(vc->mode_count * sizeof(*vc->modes));
...
static int vorbis_parse_id_hdr(vorbis_context *vc)
{
    ...
    vc->channel_residues =  (float *)av_malloc((vc->blocksize[1]  / 2) * vc->audio_channels * sizeof(*vc->channel_residues));
    vc->channel_floors   =  (float *)av_malloc((vc->blocksize[1]  / 2) * vc->audio_channels * sizeof(*vc->channel_floors));
    vc->saved            =  (float *)av_mallocz((vc->blocksize[1] / 4) * vc->audio_channels * sizeof(*vc->saved));
...
{
    vorbis_context *vc = (vorbis_context *)avccontext->priv_data;
...
static const enum AVSampleFormat _ff_vorbis_decoder[] = { AV_SAMPLE_FMT_FLT, AV_SAMPLE_FMT_S16, AV_SAMPLE_FMT_NONE };
AVCodec ff_vorbis_decoder = {
	...
	/*.sample_fmts			= */	_ff_vorbis_decoder,
