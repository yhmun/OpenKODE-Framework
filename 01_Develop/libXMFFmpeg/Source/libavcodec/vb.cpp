...
{
    VBDecContext * const c = (VBDecContext *const)avctx->priv_data;
...
static av_cold int decode_init(AVCodecContext *avctx)
{
    ...
    c->frame      = (uint8_t *)av_mallocz(avctx->width * avctx->height);
    c->prev_frame = (uint8_t *)av_mallocz(avctx->width * avctx->height);
...
{
    VBDecContext *c = (VBDecContext *)avctx->priv_data;
