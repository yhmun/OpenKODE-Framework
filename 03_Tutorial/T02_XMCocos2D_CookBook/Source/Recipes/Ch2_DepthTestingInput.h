...
#ifndef __Ch2_DepthTestingInput_h__
#define __Ch2_DepthTestingInput_h__

class Ch2_DepthTestingInput : public Recipe
{
	public :

		SCENE_FUNC ( Ch2_DepthTestingInput );
...
#endif	// __Ch2_DepthTestingInput_h__
