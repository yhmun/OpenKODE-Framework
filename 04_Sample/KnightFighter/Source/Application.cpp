...
{
	CCSize		tDesignedSize ( 480, 320 );
	CCSize		tResourceSize ( 480, 320 );

	// Initialize Resolution
	CCEGLView::sharedOpenGLView ( )->setDesignResolutionSize ( tDesignedSize, kResolutionExactFit );
...
//	CCDirector::sharedDirector ( )->setDisplayStats ( KD_TRUE );
	CCDirector::sharedDirector ( )->setContentScaleFactor ( tResourceSize.cx / tDesignedSize.cx );
