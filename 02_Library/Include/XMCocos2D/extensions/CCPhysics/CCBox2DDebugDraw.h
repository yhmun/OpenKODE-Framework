...
// inside b2World::Step.
class CCBox2DDebugDraw : public b2Draw
{
	public :

		CCBox2DDebugDraw ( KDfloat fRatio = 1.0f );

		CCBox2DDebugDraw ( KDfloat fRatio, KDfloat PerspectiveRatio, const CCSize& tAreaSize );
	...
	protected :
		...
		virtual KDfloat		convertPositionX ( const CCSize& tAreaSize, KDfloat x );
		virtual KDfloat		convertPositionY ( const CCSize& tAreaSize, KDfloat y );
