...
#include "scripting/lua/bindings/CCLuaValue.h"
...
#endif
    tolua_pushusertype(tolua_S,(void*)&self->tEndPosition,"CCPoint");
    return 1;
}
...
#endif
    tolua_pushusertype(tolua_S,(void*)&self->tControlPoint1,"CCPoint");
    return 1;
}
...
static int tolua_set_ccBezierConfig_controlPoint_1(lua_State* tolua_S)
{
    ...
    {
        self->tControlPoint1 = controlPoint_1;
    }
    return 0;
}
...
#endif
    tolua_pushusertype(tolua_S,(void*)&self->tControlPoint2,"CCPoint");
    return 1;
}
...
static int tolua_set_ccBezierConfig_controlPoint_2(lua_State* tolua_S)
{
    ...
    {
        self->tControlPoint2 = controlPoint_2;
    }
    return 0;
}
...
#endif
    {
        const EGLView* self = (const EGLView*)  tolua_tousertype(tolua_S,1,0);
#ifndef TOLUA_RELEASE
...
#endif
    {
        EGLView* self = (EGLView*)  tolua_tousertype(tolua_S,1,0);
        float width = ((float)  tolua_tonumber(tolua_S,2,0));
        float height = ((float)  tolua_tonumber(tolua_S,3,0));
#ifndef TOLUA_RELEASE
