...
#define LOADCHROMA(t,i)                             \
    U = pu[i];                                      \
    V = pv[i];                                      \
    r = (t *)c->table_rV[V+YUVRGB_TABLE_HEADROOM];                     \
    g = (t *)(c->table_gU[U+YUVRGB_TABLE_HEADROOM] + c->table_gV[V+YUVRGB_TABLE_HEADROOM]);  \
    b = (t *)c->table_bU[U+YUVRGB_TABLE_HEADROOM];
...
YUV2RGBFUNC(yuv2rgb_c_48, uint8_t, 0)
    LOADCHROMA(uint8_t, 0);
    PUTRGB48(dst_1,py_1,0);
    PUTRGB48(dst_2,py_2,0);

    LOADCHROMA(uint8_t, 1);
    PUTRGB48(dst_2,py_2,1);
    PUTRGB48(dst_1,py_1,1);

    LOADCHROMA(uint8_t, 2);
    PUTRGB48(dst_1,py_1,2);
    PUTRGB48(dst_2,py_2,2);

    LOADCHROMA(uint8_t, 3);
...
YUV2RGBFUNC(yuv2rgb_c_32, uint32_t, 0)
    LOADCHROMA(uint32_t, 0);
    PUTRGB(dst_1,py_1,0);
    PUTRGB(dst_2,py_2,0);

    LOADCHROMA(uint32_t, 1);
    PUTRGB(dst_2,py_2,1);
    PUTRGB(dst_1,py_1,1);

    LOADCHROMA(uint32_t, 2);
    PUTRGB(dst_1,py_1,2);
    PUTRGB(dst_2,py_2,2);

    LOADCHROMA(uint32_t, 3);
    PUTRGB(dst_2,py_2,3);
    PUTRGB(dst_1,py_1,3);
ENDYUV2RGBLINE(8)
    LOADCHROMA(uint32_t, 0);
...
YUV2RGBFUNC(yuv2rgb_c_16, uint16_t, 0)
    LOADCHROMA(uint16_t, 0);
    PUTRGB(dst_1,py_1,0);
    PUTRGB(dst_2,py_2,0);

    LOADCHROMA(uint16_t, 1);
    PUTRGB(dst_2,py_2,1);
    PUTRGB(dst_1,py_1,1);

    LOADCHROMA(uint16_t, 2);
    PUTRGB(dst_1,py_1,2);
    PUTRGB(dst_2,py_2,2);

    LOADCHROMA(uint16_t, 3);
    PUTRGB(dst_2,py_2,3);
    PUTRGB(dst_1,py_1,3);
CLOSEYUV2RGBFUNC(8)
