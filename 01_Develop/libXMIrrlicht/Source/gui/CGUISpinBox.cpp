...
#if   defined(SHP)
#elif defined(WINCE)
	swprintf(str, (const wchar_t*)FormatString.c_str(), val);
#else
...
#if   defined(SHP)
#elif defined(WINCE)
	swprintf(str, (const wchar_t*)FormatString.c_str(), RangeMin);
#else
...
#if   defined(SHP)
#elif defined(WINCE)
	swprintf(str, (const wchar_t*)FormatString.c_str(), RangeMax);
#else
