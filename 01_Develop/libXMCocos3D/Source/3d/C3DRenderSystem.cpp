...
{
    _renderChannelManager = new RenderChannelManager();
    _renderChannelManager->initChannels();
...
{
    if (_renderChannelManager)
    {
        _renderChannelManager->finiChannels();
        delete _renderChannelManager;
        _renderChannelManager = NULL;
    }
