                ...
                const AVIOInterruptCB *int_cb)
{
    ...
    KDsize proto_len = strspn(filename, URL_SCHEME_CHARS);
...
int ffurl_write(URLContext *h, const unsigned char *buf, int size)
{
    ...
    return retry_transfer_wrapper(h, (unsigned char *)buf, size, size, (int (*)(URLContext *,unsigned char *,int))h->prot->url_write);
}
