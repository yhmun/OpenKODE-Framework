...
#ifndef __XMChapter_h__
#define __XMChapter_h__

//#include "Node/Layer/XMChapterSelect.h"

class XMChapter : public Scene
{
	public :
		
							 XMChapter ( KDvoid );
				virtual	    ~XMChapter ( KDvoid );

							CREATE_FUNC ( XMChapter );
...
//				XMChapterSelect*					m_pChapterSel;
};

#endif  // __XMChapter_h__