...
private:
    ...
    void GetkdRandomAABB(b2AABB* aabb)
    {
        b2Vec2 w; w.Set(2.0f * m_proxyExtent, 2.0f * m_proxyExtent);
        //aabb->lowerBound.x = -m_proxyExtent;
        //aabb->lowerBound.y = -m_proxyExtent + m_worldExtent;
        aabb->lowerBound.x = kdRandomFloat(-m_worldExtent, m_worldExtent);
        aabb->lowerBound.y = kdRandomFloat(0.0f, 2.0f * m_worldExtent);
    ...
    {
        b2Vec2 d;
        d.x = kdRandomFloat(-0.5f, 0.5f);
        d.y = kdRandomFloat(-0.5f, 0.5f);
        //d.x = 2.0f;
        //d.y = 0.0f;
        aabb->lowerBound += d;
        aabb->upperBound += d;
