                           ...
                           AVFormatParameters *ap)
{
    ...
    vst->codec->extradata = (uint8_t *)av_mallocz(VMD_HEADER_SIZE + FF_INPUT_BUFFER_PADDING_SIZE);
    ...
    raw_frame_table = (unsigned char *)av_malloc(raw_frame_table_size);
    vmd->frame_table = (vmd_frame *)av_malloc((vmd->frame_count * vmd->frames_per_block + sound_buffers) * sizeof(vmd_frame));
