...
void ActionBezier::onEnter()
{
    ...
    bezier.tControlPoint1 = Point(0, s.height/2);
    bezier.tControlPoint2 = Point(300, -s.height/2);
    bezier.tEndPosition = Point(300,100);
    ...
    bezier2.tControlPoint1 = Point(100, s.height/2);
    bezier2.tControlPoint2 = Point(200, -s.height/2);
    bezier2.tEndPosition = Point(240,160);
