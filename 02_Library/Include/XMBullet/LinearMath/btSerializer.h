...
public:
	...
	virtual	btChunk*	allocate(KDsize size, int numElements) = 0;
...
public:	
		...
		virtual unsigned char* internalAlloc(KDsize size)
		{
			unsigned char* ptr = 0;
		...
		virtual	btChunk*	allocate(KDsize size, int numElements)
		{
