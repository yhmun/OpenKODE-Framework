...
#include "XMBullet/LinearMath/btConvexHullComputer.h"
...
{
	btVector3 _min(btScalar(1e30), btScalar(1e30), btScalar(1e30)), _max(btScalar(-1e30), btScalar(-1e30), btScalar(-1e30));
