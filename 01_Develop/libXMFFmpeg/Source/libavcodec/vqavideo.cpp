...
static av_cold int vqa_decode_init(AVCodecContext *avctx)
{
    ...
    s->codebook = (unsigned char *)av_malloc(s->codebook_size);
    s->next_codebook_buffer = (unsigned char *)av_malloc(s->codebook_size);
    ...
    s->decode_buffer = (unsigned char *)av_malloc(s->decode_buffer_size);
