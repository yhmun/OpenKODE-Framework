...
#include "XMFFmpeg/libavutil/attributes.h"
#include "dsputil.h"
#include "dwt.h"
#include "x86/dwt.h"
...
void ff_slice_buffer_init(slice_buffer * buf, int line_count, int max_allocated_lines, int line_width, IDWTELEM * base_buffer)
{
    ...
    buf->line        = (IDWTELEM **)av_mallocz (sizeof(IDWTELEM *) * line_count);
    buf->data_stack  = (IDWTELEM **)av_malloc (sizeof(IDWTELEM *) * max_allocated_lines);

    for(i = 0; i < max_allocated_lines; i++){
        buf->data_stack[i] = (IDWTELEM *)av_malloc (sizeof(IDWTELEM) * line_width);
    }
...
static void horizontal_decompose53i(DWTELEM *b, int width){
	DWTELEM* temp = (DWTELEM*)av_malloc(sizeof(DWTELEM)*width);
...
static void horizontal_compose53i(IDWTELEM *b, int width){
	IDWTELEM* temp = (IDWTELEM*)av_malloc(sizeof(IDWTELEM)*width);
    const int width2 = width       >> 1;
    const int w2     = (width + 1) >> 1;
    int x;
...
{
    vertical_compose_3tap vertical_compose_l0 = (vertical_compose_3tap)d->vertical_compose_l0;
    vertical_compose_5tap vertical_compose_h0 = (vertical_compose_5tap)d->vertical_compose_h0;
...
{
    vertical_compose_3tap vertical_compose_l0 = (vertical_compose_3tap)d->vertical_compose_l0;
    vertical_compose_3tap vertical_compose_h0 = (vertical_compose_3tap)d->vertical_compose_h0;
    DWTCompose *cs = d->cs + level;
...
{
    vertical_compose_5tap vertical_compose_l0 = (vertical_compose_5tap)d->vertical_compose_l0;
    vertical_compose_5tap vertical_compose_h0 = (vertical_compose_5tap)d->vertical_compose_h0;
    DWTCompose *cs = d->cs + level;
...
{
    vertical_compose_2tap vertical_compose = (vertical_compose_2tap)d->vertical_compose;
    int y = d->cs[level].y;
...
{
    vertical_compose_9tap vertical_compose_l0 = (vertical_compose_9tap)d->vertical_compose_l0;
    vertical_compose_9tap vertical_compose_h0 = (vertical_compose_9tap)d->vertical_compose_h0;
    int i, y;
    IDWTELEM *b[8];
...
static void spatial_compose_daub97i_dy(DWTContext *d, int level, int width, int height, int stride)
{
    vertical_compose_3tap vertical_compose_l0 = (vertical_compose_3tap)d->vertical_compose_l0;
    vertical_compose_3tap vertical_compose_h0 = (vertical_compose_3tap)d->vertical_compose_h0;
    vertical_compose_3tap vertical_compose_l1 = (vertical_compose_3tap)d->vertical_compose_l1;
    vertical_compose_3tap vertical_compose_h1 = (vertical_compose_3tap)d->vertical_compose_h1;
    DWTCompose *cs = d->cs + level;
                          ...
                          IDWTELEM *temp)
{
    ...
    case DWT_DIRAC_DD9_7:
        ...
        d->vertical_compose_l0	= (void (*)(void))vertical_compose53iL0;
        d->vertical_compose_h0	= (void (*)(void))vertical_compose_dd97iH0;
    ...
    case DWT_DIRAC_LEGALL5_3:
        ...
        d->vertical_compose_l0	= (void (*)(void))vertical_compose53iL0;
        d->vertical_compose_h0	= (void (*)(void))vertical_compose_dirac53iH0;
        d->horizontal_compose	= horizontal_compose_dirac53i;
        d->support = 3;
        break;
    case DWT_DIRAC_DD13_7:
        d->spatial_compose		= spatial_compose_dd137i_dy;
        d->vertical_compose_l0	= (void (*)(void))vertical_compose_dd137iL0;
        d->vertical_compose_h0	= (void (*)(void))vertical_compose_dd97iH0;
    ...
    case DWT_DIRAC_HAAR1:
        ...
        d->vertical_compose		= (void (*)(void))vertical_compose_haar;
    ...
    case DWT_DIRAC_FIDELITY:
        ...
        d->vertical_compose_l0	= (void (*)(void))vertical_compose_fidelityiL0;
        d->vertical_compose_h0	= (void (*)(void))vertical_compose_fidelityiH0;
        d->horizontal_compose	= horizontal_compose_fidelityi;
        break;
    case DWT_DIRAC_DAUB9_7:
        d->spatial_compose		= spatial_compose_daub97i_dy;
        d->vertical_compose_l0	= (void (*)(void))vertical_compose_daub97iL0;
        d->vertical_compose_h0	= (void (*)(void))vertical_compose_daub97iH0;
        d->vertical_compose_l1	= (void (*)(void))vertical_compose_daub97iL1;
        d->vertical_compose_h1	= (void (*)(void))vertical_compose_daub97iH1;
