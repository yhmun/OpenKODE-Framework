...
{
    PCMBRDecode *s = (PCMBRDecode *)avctx->priv_data;
...
static const enum AVSampleFormat _ff_pcm_bluray_decoder[] = {AV_SAMPLE_FMT_S16, AV_SAMPLE_FMT_S32, AV_SAMPLE_FMT_NONE};
AVCodec ff_pcm_bluray_decoder = {
	...
	/*.sample_fmts			= */	_ff_pcm_bluray_decoder,
};
