...
static av_cold int encode_init(AVCodecContext *avctx)
{
    ...
    if(s->flags & CODEC_FLAG_GLOBAL_HEADER){
        ...
        s->avctx->extradata= (uint8_t *)av_malloc(1024);
...
static const AVOption options[] = {
    { "data_partitioning",       "Use data partitioning.",      OFFSET(data_partitioning), AV_OPT_TYPE_INT, 0, NULL, 0, 1, VE },
...
static const enum PixelFormat _ff_mpeg4_encoder[] = {PIX_FMT_YUV420P, PIX_FMT_NONE};
