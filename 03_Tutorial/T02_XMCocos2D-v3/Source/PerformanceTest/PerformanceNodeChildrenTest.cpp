...
void AddSprite::update(float dt)
{
    ...
    if( totalToAdd > 0 )
    {
        ...
        // Don't include the sprite creation time and kdRandom as part of the profiling
        ...
        // add them with kdRandom Z (very important!)
        CC_PROFILER_START( this->profilerName() );
...
{
    return "Adds sprites with kdRandom z. See console";
}
