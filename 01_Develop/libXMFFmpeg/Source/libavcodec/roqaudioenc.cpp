...
{
    ROQDPCMContext *context = (ROQDPCMContext *)avctx->priv_data;
...
static const enum AVSampleFormat _ff_roq_dpcm_encoder[] = {AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE};
AVCodec ff_roq_dpcm_encoder = {
	...
	/*.sample_fmts			= */	_ff_roq_dpcm_encoder,
};
