...
static KDvoid SetAnimate ( KDvoid )
{
	...
	{
		0.0f,
		-200.0f, 0.0f, -120.0f,				// position
		-90.0f, 0.0f, 1.0f, 0.0f,			// rotate
		1.0f,								// alpha
	...
	tls->xmg_ani[ 0 ]->SetKeyFrameByMask ( XMG_ANI_AXIS | XMG_ANI_ROTATE | XMG_ANI_ALPHA, 3, ani_prev );
	tls->xmg_ani[ 1 ]->SetKeyFrameByMask ( XMG_ANI_POSITION | XMG_ANI_ROTATE | XMG_ANI_ALPHA, 3, ani_post );
}
...
{	
	...
	tls->xmg_text->SetText ( "XMGraphics : Cover animation" );
