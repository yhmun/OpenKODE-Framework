...
av_cold int ff_ac3_float_mdct_init(AC3EncodeContext *s)
{
    ...
    window = (float *)av_malloc(n * sizeof(*window));
    if (!window) {
...
#if CONFIG_AC3_ENCODER
static const enum AVSampleFormat _ff_ac3_encoder[] = {AV_SAMPLE_FMT_FLT,AV_SAMPLE_FMT_NONE};
