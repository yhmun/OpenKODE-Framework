...
MenuLayerMainMenu::MenuLayerMainMenu()
{
    ...
    m_pTouchListener->onTouchBegan = CC_CALLBACK_2(MenuLayerMainMenu::onTouchBegan, this);
    m_pTouchListener->onTouchMoved = CC_CALLBACK_2(MenuLayerMainMenu::onTouchMoved, this);
    m_pTouchListener->onTouchEnded = CC_CALLBACK_2(MenuLayerMainMenu::onTouchEnded, this);
    m_pTouchListener->onTouchCancelled = CC_CALLBACK_2(MenuLayerMainMenu::onTouchCancelled, this);
    
    m_pEventDispatcher->addEventListenerWithFixedPriority(m_pTouchListener, 1);
...
{
    static_cast<LayerMultiplex*>(m_pParent)->switchTo(1);
}

void MenuLayerMainMenu::menuCallbackConfig(Object* sender)
{
    static_cast<LayerMultiplex*>(m_pParent)->switchTo(3);
}

void MenuLayerMainMenu::allowTouches(float dt)
{
    m_pEventDispatcher->setPriority(m_pTouchListener, 1);
...
{
    static_cast<LayerMultiplex*>(m_pParent)->switchTo(2);
}

void MenuLayerMainMenu::menuCallbackBugsTest(Object *pSender)
{
    static_cast<LayerMultiplex*>(m_pParent)->switchTo(4);
}
...
{
    static_cast<LayerMultiplex*>(m_pParent)->switchTo(5);
}
...
{
    static_cast<LayerMultiplex*>(m_pParent)->switchTo(0);
}
...
RemoveMenuItemWhenMove::RemoveMenuItemWhenMove()
{
    ...
    m_pTouchListener->onTouchBegan = CC_CALLBACK_2(RemoveMenuItemWhenMove::onTouchBegan, this);
    m_pTouchListener->onTouchMoved = CC_CALLBACK_2(RemoveMenuItemWhenMove::onTouchMoved, this);
    
    m_pEventDispatcher->addEventListenerWithFixedPriority(m_pTouchListener, -129);
