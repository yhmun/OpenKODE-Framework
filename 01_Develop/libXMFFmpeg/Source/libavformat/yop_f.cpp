...
{
    YopDecContext *yop = (YopDecContext *)s->priv_data;
    AVIOContext *pb  = s->pb;
    ...
    video_stream->codec->extradata = (uint8_t *)av_mallocz(video_stream->codec->extradata_size +
                         ...
                         int64_t timestamp, int flags)
{
    ...
    frame_count    = (int)((pos_max - pos_min) / yop->frame_size);
