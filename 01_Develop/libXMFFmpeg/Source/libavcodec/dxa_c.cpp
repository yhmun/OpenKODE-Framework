...
static int decode_frame(AVCodecContext *avctx, void *data, int *data_size, AVPacket *avpkt)
{
    ...
    DxaDecContext * const c = (DxaDecContext *const)avctx->priv_data;
    ...
    dsize = c->dsize;
    if((compr != 4 && compr != -1) && uncompress(c->decomp_buf, (z_uLongf *)&dsize, buf + 9, buf_size - 9) != Z_OK){
...
static av_cold int decode_init(AVCodecContext *avctx)
{
    ...
    if((c->decomp_buf = (uint8_t *)av_malloc(c->dsize)) == NULL) {
