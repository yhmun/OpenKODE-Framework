...
#include "internal.h"
#include "XMFFmpeg/libavutil/common.h" /* for av_reverse */
...
{
    PCMDecode *s = (PCMDecode *)avctx->priv_data;
    int i;
...
static const enum AVSampleFormat _ff_ ## name_ ## _encoder[] = {sample_fmt_,AV_SAMPLE_FMT_NONE}; \
AVCodec ff_ ## name_ ## _encoder = {									\
	...
	/*.sample_fmts			= */	_ff_ ## name_ ## _encoder,			\
	/*.channel_layouts		= */	0,									\
	/*.max_lowres			= */	0,									\
	/*.priv_class			= */	0,									\
	/*.profiles				= */	0,									\
...
static const enum AVSampleFormat _ff_ ## name_ ## _decoder[] = {sample_fmt_,AV_SAMPLE_FMT_NONE}; \
AVCodec ff_ ## name_ ## _decoder = {									\
    ...
    /*.long_name			= */	NULL_IF_CONFIG_SMALL(long_name_),	\
	/*.supported_samplerates= */	0,									\
	/*.sample_fmts			= */	_ff_ ## name_ ## _decoder,			\
}
#else
