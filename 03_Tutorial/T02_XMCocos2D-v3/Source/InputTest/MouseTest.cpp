...
MouseTest::MouseTest()
{
    ...
    m_pEventDispatcher->addEventListenerWithSceneGraphPriority(_mouseListener, this);
...
MouseTest::~MouseTest()
{
    m_pEventDispatcher->removeEventListener(_mouseListener);
...
void MouseTest::onMouseDown(Event *event)
{
    ...
    str += xmGetKeyName(e->getMouseButton());
