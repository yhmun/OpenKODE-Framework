 ...
 *
 *      File            main.cpp
 *      Description     XMGraphics : Rotation animation demo 1
...
{	
	...
	tls->xmg_tex[0]  = new XMGTexture ( "/res/image/widget1.jpg" );
	tls->xmg_tex[1]  = new XMGTexture ( "/res/image/widget2.jpg" );
	tls->xmg_tex[2]  = new XMGTexture ( "/res/image/widget3.jpg" );
	...
	tls->xmg_text->SetText ( "XMGraphics : Rotate 1" );
