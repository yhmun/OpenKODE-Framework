...
static av_cold int wv_alloc_frame_context(WavpackContext *c)
{
    ...
    c->fdec[c->fdec_num] = (WavpackFrameContext *)av_mallocz(sizeof(**c->fdec));
...
{
    WavpackContext *s = (WavpackContext *)avctx->priv_data;
...
{
    WavpackContext *wc = (WavpackContext *)avctx->priv_data;
