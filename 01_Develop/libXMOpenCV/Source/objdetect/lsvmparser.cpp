...
void parserRFilter  ( KDFile * xmlf, int p, CvLSVMFilterObject * model, float *b){
    int st = 0;
    int sizeX=0, sizeY=0;
    int tag;
    int tagVal;
        ...
        if(ch == '<'){
            ...
            if(ch == '>'){
                ...
                if(tagVal == WEIGHTS){
                    ...
                    kdFread(data, sizeof(double), p * sizeX * sizeY, xmlf);
...
void parserV  (KDFile * xmlf, int /*p*/, CvLSVMFilterObject * model){
    int st = 0;
    int tag;
    int tagVal;
    char ch;
...
void parserD  (KDFile * xmlf, int /*p*/, CvLSVMFilterObject * model){
    int st = 0;
    int tag;
    int tagVal;
    char ch;
...
void parserPFilter  (KDFile * xmlf, int p, int /*N_path*/, CvLSVMFilterObject * model){
    int st = 0;
    int sizeX=0, sizeY=0;
    int tag;
    int tagVal;
...
void parserPFilterS (KDFile * xmlf, int p, CvLSVMFilterObject *** model, int *last, int *max){
    int st = 0;
    int N_path = 0;
    int tag;
    int tagVal;
...
void parserComp (KDFile * xmlf, int p, int *N_comp, CvLSVMFilterObject *** model, float *b, int *last, int *max){
    int st = 0;
    int tag;
    int tagVal;
    char ch;
...
void parserModel(KDFile * xmlf, CvLSVMFilterObject *** model, int *last, int *max, int **comp, float **b, int *count, float * score){
    int p = 0;
    int N_comp = 0;
    int * cmp;
    float *bb;
