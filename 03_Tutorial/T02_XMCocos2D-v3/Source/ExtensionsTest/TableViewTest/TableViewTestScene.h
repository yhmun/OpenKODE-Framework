...
public:
    ...
    virtual cocos2d::Size tableCellSizeForIndex(cocos2d::extension::TableView *table, KDint32 idx);
    virtual cocos2d::extension::TableViewCell* tableCellAtIndex(cocos2d::extension::TableView *table, KDint32 idx);
    virtual KDint32 numberOfCellsInTableView(cocos2d::extension::TableView *table);
};
