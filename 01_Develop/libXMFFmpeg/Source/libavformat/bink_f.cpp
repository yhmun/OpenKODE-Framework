...
{
    BinkDemuxContext *bink = (BinkDemuxContext *)s->priv_data;
    AVIOContext *pb = s->pb;
    ...
    vst->codec->extradata  = (uint8_t *)av_mallocz(4 + FF_INPUT_BUFFER_PADDING_SIZE);
    ...
    if (bink->num_audio_tracks) {
        ...
        for (i = 0; i < bink->num_audio_tracks; i++) {
            ...
            ast->codec->extradata = (uint8_t *)av_mallocz(4 + FF_INPUT_BUFFER_PADDING_SIZE);
