...
LabelFNTColokdRandOpacity::LabelFNTColokdRandOpacity()
{
    _time = 0;
    ...
    schedule( schedule_selector(LabelFNTColokdRandOpacity::step) );//:@selector(step:)];
}

void LabelFNTColokdRandOpacity::step(float dt)
{
    _time += dt;
    char string[15] = {0};
...
std::string LabelFNTColokdRandOpacity::title()
{
    return "New Label + .FNT file";
}

std::string LabelFNTColokdRandOpacity::subtitle()
{
