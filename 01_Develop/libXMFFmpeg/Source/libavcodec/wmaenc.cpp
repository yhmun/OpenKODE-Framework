...
static int encode_init(AVCodecContext * avctx){
    ...
    if (avctx->codec->id == CODEC_ID_WMAV1) {
        extradata= (uint8_t *)av_malloc(4);
        avctx->extradata_size= 4;
        AV_WL16(extradata, flags1);
        AV_WL16(extradata+2, flags2);
    } else if (avctx->codec->id == CODEC_ID_WMAV2) {
        extradata= (uint8_t *)av_mallocz(10);
...
static const enum AVSampleFormat _ff_wmav1_encoder[] = {AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE};
...
AVCodec ff_wmav1_encoder = {
	...
	/*.sample_fmts			= */	_ff_wmav1_encoder,
};

static const enum AVSampleFormat _ff_wmav2_encoder[] = {AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE};
