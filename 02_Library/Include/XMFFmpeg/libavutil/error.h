 ...
 * cannot be found
 */
int av_strerror(int errnum, char *errbuf, KDsize errbuf_size);
...
#undef  EINVAL
#define EINVAL	KD_EINVAL

#undef	ENOMEM
#define ENOMEM	KD_ENOMEM

#undef	EIO
#define	EIO		KD_EIO

#undef	ENOENT
#define	ENOENT	KD_ENOENT

#undef	ENOSYS
#define	ENOSYS	KD_ENOSYS

#undef	EAGAIN
#define	EAGAIN	KD_EAGAIN
...
#undef	EFBIG
#define	EFBIG	KD_EFBIG

#undef	ENAMETOOLONG
#define	ENAMETOOLONG	KD_ENAMETOOLONG

#undef  errno
#define errno           kdGetError()
