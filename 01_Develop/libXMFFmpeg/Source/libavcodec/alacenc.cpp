...
{
    AlacEncodeContext *s    = (AlacEncodeContext *)avctx->priv_data;
    int ret;
    uint8_t *alac_extradata = (uint8_t *)av_mallocz(ALAC_EXTRADATA_SIZE+1);
...
verbatim:
    ...
    if (s->compression_level == 0 || verbatim_flag) {
        ...
        init_sample_buffers(s, (const int16_t *)data);
...
static const enum AVSampleFormat _ff_alac_encoder[] = { AV_SAMPLE_FMT_S16, AV_SAMPLE_FMT_NONE };
