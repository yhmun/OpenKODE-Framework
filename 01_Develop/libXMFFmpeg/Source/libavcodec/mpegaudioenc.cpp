...
{
    MpegAudioContext *s = (MpegAudioContext *)avctx->priv_data;
...
static const enum AVSampleFormat _ff_mp2_encoder[] = {AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE};
static const int __ff_mp2_encoder[] = {44100, 48000,  32000, 22050, 24000, 16000, 0};
AVCodec ff_mp2_encoder = {
	...
	/*.next					= */	0,
	/*.flush				= */	0,
	/*.supported_framerates	= */	(const AVRational *)__ff_mp2_encoder,
	/*.pix_fmts				= */	0,
    /*.long_name			= */	NULL_IF_CONFIG_SMALL("MP2 (MPEG audio layer 2)"),
	/*.supported_samplerates= */	0,
	/*.sample_fmts			= */	_ff_mp2_encoder,
	/*.channel_layouts		= */	0,
	/*.max_lowres			= */	0,
	/*.priv_class			= */	0,
	/*.profiles				= */	0,
