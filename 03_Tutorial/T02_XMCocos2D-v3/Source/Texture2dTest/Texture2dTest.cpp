...
void TexturePVRRGBA4444GZ::onEnter()
{
    ...
    auto img = Sprite::create("Images/test_image_rgba4444.pvr.gz_");
...
void TextureMemoryAlloc::updateImage(cocos2d::Object *sender)
{
	...
	switch (tag) 
    {
		case 0:
			...
			break;
		case 1:
			file = "Images/test_1021x1024_rgba8888.pvr.gz_";
			break;
		case 2:
			file = "Images/test_1021x1024_rgb888.pvr.gz_";
			break;
		case 3:
			file = "Images/test_1021x1024_rgba4444.pvr.gz_";
			break;
		case 4:
			file = "Images/test_1021x1024_a8.pvr.gz_";
			break;
	}
