...
C3DStatRender::C3DStatRender(cocos2d::Node* parent, float statfont):_parent(parent), _fontSize(statfont), _UpdateInterval(200), _UpdateIntervalAcc(0)
{
	_TriangleDrawLabel = cocos2d::LabelTTF::create("draw triangles: ", "Arial", _fontSize);
	_TriangleTotalLabel = cocos2d::LabelTTF::create("total triangles: ", "Arial", _fontSize);
	_DrawCallLabel = cocos2d::LabelTTF::create("draw call: ", "Arial", _fontSize);
	...
	cocos2d::Size size = _parent->getContentSize();
	setStatLabelPos(cocos2d::Point(size.width - _fontSize * 10, size.height - _fontSize * 3));
}
...
void C3DStatRender::setStatLabelPos(const cocos2d::Point& point)
{
	cocos2d::Point pt = point;        
