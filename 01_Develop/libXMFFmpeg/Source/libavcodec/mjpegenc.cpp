...
av_cold int ff_mjpeg_encode_init(MpegEncContext *s)
{
    ...
    m = (MJpegContext *)av_malloc(sizeof(MJpegContext));
    if (!m)
        return -1;
...
static const enum PixelFormat _ff_mjpeg_encoder[] = {PIX_FMT_YUVJ420P, PIX_FMT_YUVJ422P, PIX_FMT_NONE};
AVCodec ff_mjpeg_encoder = {
	...
	/*.pix_fmts				= */	_ff_mjpeg_encoder,
    /*.long_name			= */	NULL_IF_CONFIG_SMALL("MJPEG (Motion JPEG)"),
};

static const enum PixelFormat _ff_amv_encoder[] = {PIX_FMT_YUVJ420P, PIX_FMT_YUVJ422P, PIX_FMT_NONE};
