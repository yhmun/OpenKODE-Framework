...
{
    DPXContext *s = (DPXContext *)avctx->priv_data;
...
#define HEADER_SIZE 1664  /* DPX Generic header */
    ...
    case 8:
    case 16:
        size = avpicture_layout((const AVPicture *)data, avctx->pix_fmt,
    ...
    case 10:
        ...
        if (buf_size < HEADER_SIZE + size)
            return -1;
        encode_rgb48_10bit((AVCodecContext *)avctx, (const AVPicture *)data, buf + HEADER_SIZE);
        break;
    default:
...
static const enum PixelFormat _ff_dpx_encoder[] = {
        PIX_FMT_RGB24,
        PIX_FMT_RGBA,
        PIX_FMT_RGB48LE,
        PIX_FMT_RGB48BE,
