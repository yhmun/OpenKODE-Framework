...
//#include "../2d/etouch_dispatcher/CCTouchDelegateProtocol.h"

#include "EnumDef.h"
#include <string>

#include "3d/C3DRenderState.h"
#include "3d/C3DEnvConf.h"
...
//	virtual void ccTouchesCancelled(cocos2d::Set *pTouches, cocos2d::Event *pEvent){};
	...
	void setEnvConf(const C3DEnvConf& conf) { _envConfig = conf; }
public:
...
protected:
    ...
    State _state;   
	cocos3d::C3DRenderSystem* _renderSystem;

	cocos3d::C3DScene* _scene;   //The Game main scene.
