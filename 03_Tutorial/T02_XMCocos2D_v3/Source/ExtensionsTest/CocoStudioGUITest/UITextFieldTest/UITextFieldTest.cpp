...
void UITextFieldTest::textFieldEvent(Object *pSender, TextFiledEventType type)
{
    switch (type)
    {
        case TEXTFIELD_EVENT_ATTACH_WITH_IME:
        {
            ...
            m_pDisplayValueLabel->setText(String::createWithFormat("attach with IME")->getCString());
        }
            break;
        ...
        case TEXTFIELD_EVENT_DETACH_WITH_IME:
        {
            UITextField* textField = dynamic_cast<UITextField*>(pSender);
            Size screenSize = Director::getInstance()->getWinSize();
            textField->runAction(MoveTo::create(0.175f, Point(screenSize.width / 2.0f, screenSize.height / 2.0f)));
            m_pDisplayValueLabel->setText(String::createWithFormat("detach with IME")->getCString());
        }
            break;
            
        case TEXTFIELD_EVENT_INSERT_TEXT:
            m_pDisplayValueLabel->setText(String::createWithFormat("insert words")->getCString());
            break;
            
        case TEXTFIELD_EVENT_DELETE_BACKWARD:
            m_pDisplayValueLabel->setText(String::createWithFormat("delete word")->getCString());
            break;
...
void UITextFieldTest_MaxLength::textFieldEvent(Object *pSender, TextFiledEventType type)
{
    switch (type)
    {
        case TEXTFIELD_EVENT_ATTACH_WITH_IME:
        {
            ...
            textField->runAction(MoveTo::create(0.225f,
                                                  Point(screenSize.width / 2.0f, screenSize.height / 2.0f + textField->getContentSize().height / 2.0f)));
            m_pDisplayValueLabel->setText(String::createWithFormat("attach with IME max length %d", textField->getMaxLength())->getCString());
        }
            break;
        ...
        case TEXTFIELD_EVENT_DETACH_WITH_IME:
        {
            ...
            Size screenSize = Director::getInstance()->getWinSize();
            textField->runAction(MoveTo::create(0.175f, Point(screenSize.width / 2.0f, screenSize.height / 2.0f)));
            m_pDisplayValueLabel->setText(String::createWithFormat("detach with IME max length %d", textField->getMaxLength())->getCString());
        }
            break;
        ...
        {
            UITextField* textField = dynamic_cast<UITextField*>(pSender);
            m_pDisplayValueLabel->setText(String::createWithFormat("insert words max length %d", textField->getMaxLength())->getCString());
        }
            break;
        ...
        {
            UITextField* textField = dynamic_cast<UITextField*>(pSender);
            m_pDisplayValueLabel->setText(String::createWithFormat("delete word max length %d", textField->getMaxLength())->getCString());
        }
            break;
...
void UITextFieldTest_Password::textFieldEvent(Object *pSender, TextFiledEventType type)
{
    switch (type)
    {
        case TEXTFIELD_EVENT_ATTACH_WITH_IME:
        {
            ...
            textField->runAction(MoveTo::create(0.225f,
                                                  Point(screenSize.width / 2.0f, screenSize.height / 2.0f + textField->getContentSize().height / 2.0f)));
            m_pDisplayValueLabel->setText(String::createWithFormat("attach with IME password")->getCString());
        }
            break;
        ...
        case TEXTFIELD_EVENT_DETACH_WITH_IME:
        {
            ...
            Size screenSize = Director::getInstance()->getWinSize();
            textField->runAction(MoveTo::create(0.175f, Point(screenSize.width / 2.0f, screenSize.height / 2.0f)));
            m_pDisplayValueLabel->setText(String::createWithFormat("detach with IME password")->getCString());
        }
            break;
            
        case TEXTFIELD_EVENT_INSERT_TEXT:
            m_pDisplayValueLabel->setText(String::createWithFormat("insert words password")->getCString());
            break;
            
        case TEXTFIELD_EVENT_DELETE_BACKWARD:
            m_pDisplayValueLabel->setText(String::createWithFormat("delete word password")->getCString());
            break;
