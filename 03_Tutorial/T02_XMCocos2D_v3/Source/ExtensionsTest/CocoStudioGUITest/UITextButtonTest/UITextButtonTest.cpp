...
void UITextButtonTest::touchEvent(Object *pSender, TouchEventType type)
{
    switch (type)
    {
        case gui::TOUCH_EVENT_BEGAN:
            m_pDisplayValueLabel->setText(String::createWithFormat("Touch Down")->getCString());
            break;
            
        case gui::TOUCH_EVENT_MOVED:
            m_pDisplayValueLabel->setText(String::createWithFormat("Touch Move")->getCString());
            break;
            
        case gui::TOUCH_EVENT_ENDED:
            m_pDisplayValueLabel->setText(String::createWithFormat("Touch Up")->getCString());
            break;
            
        case gui::TOUCH_EVENT_CANCELED:
            m_pDisplayValueLabel->setText(String::createWithFormat("Touch Cancelled")->getCString());
            break;
