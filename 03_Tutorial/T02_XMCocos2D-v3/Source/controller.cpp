...
// #endif        
    ...
    _itemMenu->setContentSize(Size(VisibleRect::getVisibleRect().size.width, (g_testCount + 1.f) * (LINE_SPACE)));
    ...
    m_pEventDispatcher->addEventListenerWithSceneGraphPriority(mouseListener, this);
}
