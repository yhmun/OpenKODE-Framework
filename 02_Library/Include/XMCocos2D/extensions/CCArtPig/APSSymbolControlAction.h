...
#ifndef __APSSymbolControlAction_h__
#define __APSSymbolControlAction_h__
...
class APSSymbolControlAction : public APSAction
{
	public :
		...
		virtual KDvoid	resetTarget ( KDvoid );
		virtual KDvoid	triggerPrologues ( KDvoid );
		virtual KDvoid	interruptAllActions ( KDvoid );
...
#endif // __APSSymbolControlAction_h__
