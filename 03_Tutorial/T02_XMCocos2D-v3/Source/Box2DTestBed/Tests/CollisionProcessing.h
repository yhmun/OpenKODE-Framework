...
public:
    CollisionProcessing()
    {
        ...
        triangleBodyDef.position.Set(kdRandomFloat(xLo, xHi), kdRandomFloat(yLo, yHi));
        ...
        boxBodyDef.position.Set(kdRandomFloat(xLo, xHi), kdRandomFloat(yLo, yHi));
        ...
        circleBodyDef.position.Set(kdRandomFloat(xLo, xHi), kdRandomFloat(yLo, yHi));
