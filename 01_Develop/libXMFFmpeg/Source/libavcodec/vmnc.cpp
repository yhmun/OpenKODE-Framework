...
static int decode_frame(AVCodecContext *avctx, void *data, int *data_size, AVPacket *avpkt)
{
    ...
    VmncContext * const c = (VmncContext * const)avctx->priv_data;
    uint8_t *outptr;
    ...
    while(chunks--) {
        ...
        case MAGIC_WMVd: // cursor
            ...
            c->curbits = (uint8_t *)av_realloc(c->curbits, c->cur_w * c->cur_h * c->bpp2);
            c->curmask = (uint8_t *)av_realloc(c->curmask, c->cur_w * c->cur_h * c->bpp2);
            c->screendta = (uint8_t *)av_realloc(c->screendta, c->cur_w * c->cur_h * c->bpp2);
            load_cursor(c, src);
            src += w * h * c->bpp2 * 2;
            break;
