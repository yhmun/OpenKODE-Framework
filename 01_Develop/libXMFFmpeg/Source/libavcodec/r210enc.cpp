...
static const enum PixelFormat _ff_r210_encoder[] = { PIX_FMT_RGB48, PIX_FMT_NONE };
AVCodec ff_r210_encoder = {
	...
	/*.pix_fmts				= */	_ff_r210_encoder,
    /*.long_name			= */	NULL_IF_CONFIG_SMALL("Uncompressed RGB 10-bit"),
};
#endif
#if CONFIG_R10K_ENCODER
static const enum PixelFormat _ff_r10k_encoder[] = { PIX_FMT_RGB48, PIX_FMT_NONE };
AVCodec ff_r10k_encoder = {
	...
	/*.flush				= */	0,
	/*.supported_framerates	= */	0,
	/*.pix_fmts				= */	_ff_r10k_encoder,
    /*.long_name			= */	NULL_IF_CONFIG_SMALL("AJA Kona 10-bit RGB Codec"),
};
#endif
#if CONFIG_AVRP_ENCODER
static const enum PixelFormat _ff_avrp_encoder[] = { PIX_FMT_RGB48, PIX_FMT_NONE };
