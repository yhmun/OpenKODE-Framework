...
{
    KmvcContext *const ctx = (KmvcContext *const)avctx->priv_data;
    uint8_t *out, *src;
    int i;
    int header;
    int blocksize;
...
{
    KmvcContext *const c = (KmvcContext *const)avctx->priv_data;
    int i;
    ...
    c->frm0 = (uint8_t *)av_mallocz(320 * 200);
    c->frm1 = (uint8_t *)av_mallocz(320 * 200);
    c->cur = c->frm0;
    c->prev = c->frm1;
