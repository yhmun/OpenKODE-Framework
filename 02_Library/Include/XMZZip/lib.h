...
struct zzip_dir_hdr
{
    KDuint32    d_usize;        /* uncompressed size */
    KDuint32    d_csize;        /* compressed size */
    KDuint32    d_crc32;        /* the adler32-checksum */
    KDuint32    d_off;          /* offset of file in zipfile */
    KDuint16    d_reclen;       /* next dir_hdr structure offset */
    KDuint16    d_namlen;       /* explicit namelen of d_name */
    KDuint8     d_compr;        /* the compression type, 0 = store, 8 = inflate */
