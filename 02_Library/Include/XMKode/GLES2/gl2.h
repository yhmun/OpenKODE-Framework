 ...
 *
 *      File            gl2.h
 *      Description     OpenGL ES is a royalty-free, cross-platform API for 
 *                      full-function 2D and 3D graphics on embedded systems - 
 *                      including consoles, phones, appliances and vehicles. 
 *                      It consists of well-defined subsets of desktop OpenGL, 
 *                      creating a flexible and powerful low-level interface 
 *                      between software and graphics acceleration. OpenGL ES 
 *                      includes profiles for floating-point and fixed-point 
 *                      systems and the EGL¢â specification for portably binding 
 *                      to native windowing systems.  OpenGL ES 2.X enables full 
 *                      programmable 3D graphics. 
 *      Version         2.0, 2009-09-02 
...
GL_APICALL void         GL_APIENTRY glShaderSource ( GLuint shader, GLsizei count, const char* const* string, const GLint* length );
