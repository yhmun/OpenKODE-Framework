...
{
    CLJRContext * const a = (CLJRContext *const)avctx->priv_data;
...
{
    CLJRContext *a = (CLJRContext *)avctx->priv_data;
...
static const AVOption options[] = {
    { "dither_type",   "Dither type",   OFFSET(dither_type),        AV_OPT_TYPE_INT, 1, NULL, 0, 2, VE},
    { NULL },
};
...
static const enum PixelFormat _ff_cljr_encoder[] = { PIX_FMT_YUV411P,PIX_FMT_NONE };
