...
static int decode_frame(AVCodecContext *avctx, void *data, int *data_size, AVPacket *avpkt)
{
    ...
    CamtasiaContext * const c = (CamtasiaContext *const)avctx->priv_data;
    ...
    c->zstream.next_in = (Bytef *)encoded;
...
static av_cold int decode_init(AVCodecContext *avctx)
{
    ...
    if (c->decomp_size) {
        if ((c->decomp_buf = (unsigned char *)av_malloc(c->decomp_size)) == NULL) {
