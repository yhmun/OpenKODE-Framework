 ...
 * their own workspace files. All includes look like #include <XMZZip|*.h>, so
 ...
 * zzip_open flags.
 */
#define ZZIP_CASEINSENSITIVE	KD_O_APPEND /* do not use anymore. use CASLESS */
#define ZZIP_IGNOREPATH	        KD_O_TRUNC  /* do not use anymore. use NOPATHS */
