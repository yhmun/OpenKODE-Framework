...
typedef void * gim_alloc_function (KDsize size);
typedef void * gim_alloca_function (KDsize size);//Allocs on the heap
typedef void * gim_realloc_function (void *ptr, KDsize oldsize, KDsize newsize);
...
void * gim_alloc(KDsize size);
void * gim_alloca(KDsize size);
void * gim_realloc(void *ptr, KDsize oldsize, KDsize newsize);
...
inline void gim_simd_memcpy(void * dst, const void * src, KDsize copysize)
{
...
template<class T>
inline void gim_swap_elements(T* _array,KDsize _i,KDsize _j)
{
	T _e_tmp_ = _array[_i];
	_array[_i] = _array[_j];
	_array[_j] = _e_tmp_;
...
template<class T>
inline void gim_swap_elements_memcpy(T* _array,KDsize _i,KDsize _j)
{
...
template <int SIZE>
inline void gim_swap_elements_ptr(char * _array,KDsize _i,KDsize _j)
{
	char _e_tmp_[SIZE];
	_i*=SIZE;
	_j*=SIZE;
