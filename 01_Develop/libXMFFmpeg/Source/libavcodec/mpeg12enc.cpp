...
#define COMMON_OPTS\
    ...
    { "intra_vlc",           "Use MPEG-2 intra VLC table.",       OFFSET(intra_vlc_format),    AV_OPT_TYPE_INT, 0, NULL, 0, 1, VE },\
    { "drop_frame_timecode", "Timecode is in drop frame format.", OFFSET(drop_frame_timecode), AV_OPT_TYPE_INT, 0, NULL, 0, 1, VE}, \
    { "scan_offset",         "Reserve space for SVCD scan offset user data.", OFFSET(scan_offset), AV_OPT_TYPE_INT, 0, NULL, 0, 1, VE },
...
static const AVOption mpeg2_options[] = {
    COMMON_OPTS
    { "non_linear_quant",    "Use nonlinear quantizer.",          OFFSET(q_scale_type),         AV_OPT_TYPE_INT, 0, NULL, 0, 1, VE },
    { "alternate_scan",      "Enable alternate scantable.",       OFFSET(alternate_scan),       AV_OPT_TYPE_INT, 0, NULL, 0, 1, VE },
    { NULL },
};
...
static const enum PixelFormat _ff_mpeg1video_encoder[] = {PIX_FMT_YUV420P, PIX_FMT_NONE};
AVCodec ff_mpeg1video_encoder = {
	...
	/*.pix_fmts				= */	_ff_mpeg1video_encoder,
...
static const enum PixelFormat _ff_mpeg2video_encoder[] = {PIX_FMT_YUV420P, PIX_FMT_YUV422P, PIX_FMT_NONE};
AVCodec ff_mpeg2video_encoder = {
	...
	/*.flush				= */	0,
	/*.supported_framerates	= */	avpriv_frame_rate_tab+1,
	/*.pix_fmts				= */	_ff_mpeg2video_encoder,
