...
{
    AIFFOutputContext *aiff = (AIFFOutputContext *)s->priv_data;
    AVIOContext *pb = s->pb;
    ...
    /* FORM AIFF header */
    ffio_wfourcc(pb, (const uint8_t *)"FORM");
    aiff->form = avio_tell(pb);
    avio_wb32(pb, 0);                    /* file length */
    ffio_wfourcc(pb, (const uint8_t *)(aifc ? "AIFC" : "AIFF"));
    ...
    if (aifc) { // compressed audio
        ...
        /* Version chunk */
        ffio_wfourcc(pb, (const uint8_t *)("FVER"));
        avio_wb32(pb, 4);
    ...
    /* Common chunk */
    ffio_wfourcc(pb, (const uint8_t *)("COMM"));
    ...
    /* Sound data chunk */
    ffio_wfourcc(pb, (const uint8_t *)("SSND"));
...
static const AVCodecTag* const _ff_aiff_muxer[] = {ff_codec_aiff_tags, 0};
