                        ...
                        AVPacket *avpkt)
{
    ...
    ASV1Context * const a = (ASV1Context * const)avctx->priv_data;
...
static av_cold int decode_init(AVCodecContext *avctx){
    ...
    p->qscale_table= (int8_t *)av_malloc( p->qstride * a->mb_height);
...
static av_cold int encode_init(AVCodecContext *avctx){
    ...
    avctx->extradata= (uint8_t *)av_mallocz(8);
...
static const enum PixelFormat _ff_asv1_encoder[] = {PIX_FMT_YUV420P, PIX_FMT_NONE};
AVCodec ff_asv1_encoder = {
	...
	/*.flush				= */	0,
	/*.supported_framerates	= */	0,
	/*.pix_fmts				= */	_ff_asv1_encoder,
    /*.long_name			= */	NULL_IF_CONFIG_SMALL("ASUS V1"),
};
#endif

#if CONFIG_ASV2_ENCODER
static const enum PixelFormat _ff_asv2_encoder[] = {PIX_FMT_YUV420P, PIX_FMT_NONE};
