...
{
    const HuffEntry *aa = (const HuffEntry *)a;
	const HuffEntry *bb = (const HuffEntry *)b;
...
static int decode_frame(AVCodecContext *avctx, void *data, int *data_size, AVPacket *avpkt)
{
    ...
    UtvideoContext *c = (UtvideoContext *)avctx->priv_data;
    const uint8_t *ptr;
    int i, j;
    ...
    av_fast_malloc(&c->slice_bits, (unsigned int *)&c->slice_bits_size,
...
{
    UtvideoContext * const c = (UtvideoContext *const)avctx->priv_data;
