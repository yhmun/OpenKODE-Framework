...
{
    G726Context* c = (G726Context *)avctx->priv_data;
	...
	{
		int _t[] = { 4096, 2736, 2048, 1640 };
		avctx->frame_size = _t[c->code_size - 2];
	}
...
static const AVOption options[] = {
    { "code_size", "Bits per code", OFFSET(code_size), AV_OPT_TYPE_INT, 4, NULL, 2, 5, AE },
    { NULL },
};
...
static const enum AVSampleFormat _ff_adpcm_g726_encoder[] = {AV_SAMPLE_FMT_S16,AV_SAMPLE_FMT_NONE};
AVCodec ff_adpcm_g726_encoder = {
	...
	/*.sample_fmts			= */	_ff_adpcm_g726_encoder,
	/*.channel_layouts		= */	0,
	/*.max_lowres			= */	0,
	/*.priv_class			= */	&av_class,
	/*.profiles				= */	0,
