...
{
    BMVDecContext * const c = (BMVDecContext *const)avctx->priv_data;
    int type, scr_off;
    int i;
...
{
    BMVDecContext *c = (BMVDecContext *)avctx->priv_data;
...
{
    BMVAudioDecContext *c = (BMVAudioDecContext *)avctx->priv_data;
