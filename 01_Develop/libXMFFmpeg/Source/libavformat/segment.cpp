...
{
    SegmentContext *c = (SegmentContext *)s->priv_data;
...
{
    SegmentContext *seg = (SegmentContext *)s->priv_data;
    AVFormatContext *oc;
    int ret, i;
...
static const AVOption options[] = {
    ...
    { "segment_time",      "segment length in seconds",               OFFSET(time),    AV_OPT_TYPE_FLOAT,  2, NULL, 0, FLT_MAX, E },
    { "segment_list",      "output the segment list",                 OFFSET(list),    AV_OPT_TYPE_STRING, 0, NULL, 0, 0,       E },
    { "segment_list_size", "maximum number of playlist entries",      OFFSET(size),    AV_OPT_TYPE_INT,    5, NULL, 0, INT_MAX, E },
    { NULL },
};
