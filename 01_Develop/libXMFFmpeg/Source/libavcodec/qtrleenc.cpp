...
static av_cold int qtrle_encode_init(AVCodecContext *avctx)
{
    ...
    s->rlecode_table = (signed char *)av_mallocz(s->logical_width);
    s->skip_table    = (uint8_t *)av_mallocz(s->logical_width);
    s->length_table  = (int *)av_mallocz((s->logical_width + 1)*sizeof(int));
...
{
    QtrleEncContext * const s = (QtrleEncContext *const)avctx->priv_data;
...
static const enum PixelFormat _ff_qtrle_encoder[] = {PIX_FMT_RGB24, PIX_FMT_RGB555BE, PIX_FMT_ARGB, PIX_FMT_GRAY8, PIX_FMT_NONE};
