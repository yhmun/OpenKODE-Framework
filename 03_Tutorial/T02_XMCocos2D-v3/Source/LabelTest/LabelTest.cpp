...
void BitmapFontMultiLineAlignment::onTouchesMoved(const std::vector<Touch*>& touches, cocos2d::Event  *event)
{
    ...
    this->_arrowsShouldRetain->setPosition(Point(KD_MAX(KD_MIN(location.x, ArrowsMax*winSize.width), ArrowsMin*winSize.width), 
        this->_arrowsShouldRetain->getPosition().y));

    float labelWidth = kdFabsf(this->_arrowsShouldRetain->getPosition().x - this->_labelShouldRetain->getPosition().x) * 2;
...
BMFontUnicode::BMFontUnicode()
{
    ...
    const char *chinese  = static_cast<String*>(strings->objectForKey("chinese1"))->m_sString.c_str();
    const char *japanese = static_cast<String*>(strings->objectForKey("japanese"))->m_sString.c_str();
    const char *russian  = static_cast<String*>(strings->objectForKey("russian"))->m_sString.c_str();
    const char *spanish  = static_cast<String*>(strings->objectForKey("spanish"))->m_sString.c_str();
...
TTFFontShadowAndStroke::TTFFontShadowAndStroke()
{
    ...
    shadowTextDef.m_nFontSize = 20;
    shadowTextDef.m_sFontName = std::string("Marker Felt");
    
    shadowTextDef.m_tShadow.m_bShadowEnabled = true;
    shadowTextDef.m_tShadow.m_tShadowOffset  = shadowOffset;
    shadowTextDef.m_tShadow.m_fShadowOpacity = 1.0;
    shadowTextDef.m_tShadow.m_fShadowBlur    = 1.0;
    shadowTextDef.m_tFontFillColor   = tintColorRed;
    ...
    strokeTextDef.m_nFontSize = 20;
    strokeTextDef.m_sFontName = std::string("Marker Felt");
    
    strokeTextDef.m_tStroke.m_bStrokeEnabled = true;
    strokeTextDef.m_tStroke.m_tStrokeColor   = strokeColor;
    strokeTextDef.m_tStroke.m_fStrokeSize    = 1.5;
    
    strokeTextDef.m_tFontFillColor   = tintColorYellow;
    ...
    strokeShaodwTextDef.m_nFontSize = 20;
    strokeShaodwTextDef.m_sFontName = std::string("Marker Felt");
    
    strokeShaodwTextDef.m_tStroke.m_bStrokeEnabled = true;
    strokeShaodwTextDef.m_tStroke.m_tStrokeColor   = strokeShadowColor;
    strokeShaodwTextDef.m_tStroke.m_fStrokeSize    = 1.5;
    
    strokeShaodwTextDef.m_tShadow.m_bShadowEnabled = true;
    strokeShaodwTextDef.m_tShadow.m_tShadowOffset  = shadowOffset;
    strokeShaodwTextDef.m_tShadow.m_fShadowOpacity = 1.0;
    strokeShaodwTextDef.m_tShadow.m_fShadowBlur    = 1.0;
    
    
    strokeShaodwTextDef.m_tFontFillColor   = tintColorBlue;
