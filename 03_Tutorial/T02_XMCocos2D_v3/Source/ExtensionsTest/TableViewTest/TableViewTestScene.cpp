...
{
    CCLOG("cell touched at index: %d", cell->getIdx());
}

Size TableViewTestLayer::tableCellSizeForIndex(TableView *table, KDint32 idx)
{
    if (idx == 2) {
        return Size(100, 100);
    }
...
TableViewCell* TableViewTestLayer::tableCellAtIndex(TableView *table, KDint32 idx)
{
...
KDint32 TableViewTestLayer::numberOfCellsInTableView(TableView *table)
{
    return 20;
}
