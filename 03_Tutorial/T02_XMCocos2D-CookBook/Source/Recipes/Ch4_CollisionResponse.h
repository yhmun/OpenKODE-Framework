...
#ifndef __Ch4_CollisionResponse_h__
#define __Ch4_CollisionResponse_h__
...
class Ch4_CollisionResponse : public GameArea2D
{
	public :

		SCENE_FUNC ( Ch4_CollisionResponse );
	...
	protected :		
		...
		KDvoid					handleCollisionWithMisc ( GameMisc* pMiscA, GameMisc* pMiscB );

		KDvoid					addNewObjectWithCoords ( const CCPoint& tPoint );
};

#endif	// __Ch4_CollisionResponse_h__
