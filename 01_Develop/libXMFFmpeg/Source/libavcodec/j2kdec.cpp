...
static int get_siz(J2kDecoderContext *s)
{
    ...
    s->tile = (J2kTile *)av_mallocz(s->numXtiles * s->numYtiles * sizeof(J2kTile));
    if (!s->tile)
    ...
    for (i = 0; i < s->numXtiles * s->numYtiles; i++){
        ...
        tile->comp = (J2kComponent *)av_mallocz(s->ncomponents * sizeof(J2kComponent));
        if (!tile->comp)
            return AVERROR(ENOMEM);
    }
...
static int decode_frame(AVCodecContext *avctx,
                        ...
                        AVPacket *avpkt)
{
    J2kDecoderContext *s = (J2kDecoderContext *)avctx->priv_data;
...
static const enum PixelFormat _ff_jpeg2000_decoder[] = {PIX_FMT_GRAY8, PIX_FMT_RGB24, PIX_FMT_NONE};
