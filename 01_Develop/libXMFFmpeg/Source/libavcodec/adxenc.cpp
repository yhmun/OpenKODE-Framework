...
static int adx_encode_header(AVCodecContext *avctx, uint8_t *buf, int bufsize)
{
    ...
    bytestream_put_buffer(&buf, (const uint8_t *)"(c)CRI", 6);       /* copyright signature */
...
static const enum AVSampleFormat _ff_adpcm_adx_encoder[] = { AV_SAMPLE_FMT_S16, AV_SAMPLE_FMT_NONE };
AVCodec ff_adpcm_adx_encoder = {
	...
	/*.sample_fmts			= */	_ff_adpcm_adx_encoder,
};
