...
#if CONFIG_ASF_MUXER
static const AVCodecTag* const _ff_asf_muxer[] = {codec_asf_bmp_tags, ff_codec_bmp_tags, ff_codec_wav_tags, 0};
AVOutputFormat ff_asf_muxer = {
	...
	/*.dummy			 = */	0,
	/*.interleave_packet = */	0,
    /*.codec_tag		 = */	_ff_asf_muxer,
};
#endif

#if CONFIG_ASF_STREAM_MUXER
static const AVCodecTag* const _ff_asf_stream_muxer[] = {codec_asf_bmp_tags, ff_codec_bmp_tags, ff_codec_wav_tags, 0};
AVOutputFormat ff_asf_stream_muxer = {
	...
	/*.dummy			 = */	0,
	/*.interleave_packet = */	0,
    /*.codec_tag		 = */	_ff_asf_stream_muxer,
};
