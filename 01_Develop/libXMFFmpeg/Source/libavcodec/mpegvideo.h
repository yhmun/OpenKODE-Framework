...
static av_always_inline void ff_update_block_index(MpegEncContext *s){
...
static av_always_inline int get_bits_diff(MpegEncContext *s){
...
static av_always_inline int ff_h263_round_chroma(int x){
