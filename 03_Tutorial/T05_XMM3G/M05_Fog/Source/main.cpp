...
static KDvoid xmEventCreate ( KDvoid )
{
    ...
    M3GKeyframeSequence*  pKeyframeSequence = new M3GKeyframeSequence ( 3, 1, M3GKeyframeSequence::LINEAR );

    KDfloat  fFogFar [3][1] = { { 10.f }, { 4.f }, { 10.f } };

    pKeyframeSequence->setKeyframe   ( 0,   0, fFogFar [ 0 ] );
    pKeyframeSequence->setKeyframe   ( 1, 400, fFogFar [ 1 ] );
    pKeyframeSequence->setKeyframe   ( 2, 800, fFogFar [ 2 ] );
    ...
    M3GAnimationTrack*  pAnimationTrack = new M3GAnimationTrack ( pKeyframeSequence, M3GAnimationTrack::FAR_DISTANCE );
    ...
    M3GFog*  pFog = new M3GFog ( );
    pFog->setMode ( M3GFog::LINEAR );
    pFog->setLinear ( 4, 10 );
    pFog->setColor ( 0x000000ff );
    pFog->addAnimationTrack ( pAnimationTrack );

    M3GAppearance*  pAppearance = new M3GAppearance ( );
    pAppearance->setFog ( pFog );
