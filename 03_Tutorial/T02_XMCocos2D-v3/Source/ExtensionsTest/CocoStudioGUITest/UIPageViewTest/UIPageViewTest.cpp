...
bool UIPageViewTest::init()
{
    if (UIScene::init())
    {
        ...
        for (int i = 0; i < 3; ++i)
        {
            ...
            label->setText(String::createWithFormat("page %d", (i + 1))->getCString());
...
void UIPageViewTest::pageViewEvent(Object *pSender, PageViewEventType type)
{
    switch (type)
    {
        case PAGEVIEW_EVENT_TURNING:
        {
            ...
            m_pDisplayValueLabel->setText(String::createWithFormat("page = %d", pageView->getCurPageIndex() + 1)->getCString());
        }
            break;
